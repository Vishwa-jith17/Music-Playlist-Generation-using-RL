...
if __name__ == "__main__":
    ...
    if mode == "OFFLINE":
        ...
        while True:
            ...
            print("\nDo you want to get further recommendations?")
            print("1) Yes, with same user preferences")
            print("2) Yes, with different user preferences")
            print("3) No thanks or terminate")
